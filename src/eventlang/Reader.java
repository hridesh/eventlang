...
public class Reader {
	...
	public Program parse(String programText) {
		...
		EventLangParser p = getParser(new org.antlr.v4.runtime.CommonTokenStream(l));
		Program program = p.program().ast;
		return program;
	}
	
	protected Lexer getLexer(org.antlr.v4.runtime.ANTLRInputStream s) {
		return new EventLangLexer(s);
	}
	
	protected EventLangParser getParser(org.antlr.v4.runtime.CommonTokenStream s) {
		return new EventLangParser(s);
	}
